...
CREATE OR REPLACE FUNCTION "public"."adicionar_consumo_atomico"("p_company_id" "text", "p_date_key" "text", "p_comanda_number" "text", "p_valor" numeric) RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  UPDATE comandas
  ...
  WHERE
    ...
    AND comanda_number = p_comanda_number;

  IF NOT FOUND THEN
    RAISE EXCEPTION 'Comanda % nao encontrada para empresa % na data %',
...
ALTER FUNCTION "public"."adicionar_consumo_atomico"("p_company_id" "text", "p_date_key" "text", "p_comanda_number" "text", "p_valor" numeric) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."archive_old_partition"("partition_name" "text") RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
...
CREATE OR REPLACE FUNCTION "public"."cleanup_old_partitions"("retention_months" integer DEFAULT 12, "archive_mode" boolean DEFAULT true) RETURNS TABLE("partition_name" "text", "action" "text")
    LANGUAGE "plpgsql"
    AS $$
DECLARE
    cutoff_date DATE;
...
CREATE OR REPLACE FUNCTION "public"."close_cash_register"("p_register_id" "uuid", "p_closed_by" "uuid", "p_final_amount" numeric, "p_notes" "text" DEFAULT NULL::"text") RETURNS "jsonb"
...
CREATE OR REPLACE FUNCTION "public"."close_cash_register"("p_register_id" "uuid", "p_closed_by" "uuid", "p_closed_by_name" "text", "p_actual_balance" numeric) RETURNS "jsonb"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
    v_register record;
...
CREATE OR REPLACE FUNCTION "public"."close_comanda"("p_comanda_id" "uuid", "p_closed_by" "uuid", "p_total_amount" numeric DEFAULT 0) RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
declare
    v_result jsonb;
...
CREATE OR REPLACE FUNCTION "public"."close_comanda"("p_comanda_id" "uuid", "p_closed_by" "uuid", "p_closed_by_name" "text") RETURNS "jsonb"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
    v_comanda record;
...
CREATE OR REPLACE FUNCTION "public"."create_monthly_partition"() RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
    partition_date DATE;
...
CREATE OR REPLACE FUNCTION "public"."create_partitions_for_range"("start_month" "date", "end_month" "date") RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
    current_month DATE;
...
CREATE OR REPLACE FUNCTION "public"."drop_old_partition"("partition_name" "text") RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
    -- Detach partition from parent table
...
CREATE OR REPLACE FUNCTION "public"."execute_sql"("query" "text", "params" "jsonb" DEFAULT '{}'::"jsonb") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
...
CREATE OR REPLACE FUNCTION "public"."get_autovacuum_config"() RETURNS TABLE("setting_name" "text", "current_value" "text", "unit" "text", "description" "text")
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
  RETURN QUERY
...
CREATE OR REPLACE FUNCTION "public"."get_checkpoint_wal_config"() RETURNS TABLE("setting_name" "text", "current_value" "text", "unit" "text", "description" "text")
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
  RETURN QUERY
...
CREATE OR REPLACE FUNCTION "public"."get_next_delivery_comanda_number"("p_company_id" "uuid", "p_date_key" "text") RETURNS integer
    LANGUAGE "plpgsql"
    AS $$
DECLARE
    new_num integer;
BEGIN
    INSERT INTO public.delivery_counters (company_id, date_key, last_number)
    VALUES (p_company_id, p_date_key, 1)
    ON CONFLICT (company_id, date_key)
    DO UPDATE SET last_number = public.delivery_counters.last_number + 1
    RETURNING last_number INTO new_num;

    -- Update max from orders table to prevent repeating numbers 
    -- if orders exist but counter doesn't
    DECLARE
      max_existing integer;
    BEGIN
      SELECT COALESCE(MAX(comanda_number), 0)
      INTO max_existing
      FROM public.orders
      ...
      IF new_num <= max_existing THEN
        UPDATE public.delivery_counters 
        SET last_number = max_existing + 1
        WHERE company_id = p_company_id AND date_key = p_date_key
        RETURNING last_number INTO new_num;
      END IF;
    END;
...
ALTER FUNCTION "public"."get_next_delivery_comanda_number"("p_company_id" "uuid", "p_date_key" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_partition_status"() RETURNS TABLE("partition_name" "text", "partition_date" "date", "row_count" bigint, "size_bytes" bigint, "age_months" integer, "should_cleanup" boolean)
    LANGUAGE "plpgsql"
    AS $$
DECLARE
...
CREATE OR REPLACE FUNCTION "public"."get_performance_config"() RETURNS TABLE("setting_name" "text", "current_value" "text", "unit" "text", "category" "text")
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
  RETURN QUERY
...
CREATE OR REPLACE FUNCTION "public"."get_tables_needing_vacuum"() RETURNS TABLE("schemaname" "text", "tablename" "text", "n_dead_tup" bigint, "n_live_tup" bigint, "dead_tuple_percent" numeric, "last_autovacuum" timestamp with time zone, "recommendation" "text")
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
  RETURN QUERY
...
CREATE OR REPLACE FUNCTION "public"."get_wal_stats"() RETURNS TABLE("wal_records" bigint, "wal_fpi" bigint, "wal_bytes" numeric, "wal_buffers_full" bigint, "stats_reset" timestamp with time zone)
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
  RETURN QUERY
...
CREATE OR REPLACE FUNCTION "public"."handle_new_company_config"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
...
CREATE OR REPLACE FUNCTION "public"."notify_agendamentos_n8n"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  PERFORM net.http_post(
      url:='https://machadocunha.app.n8n.cloud/webhook/supa-agendamentos',
...
ALTER FUNCTION "public"."notify_agendamentos_n8n"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."notify_n8n_pedido_status"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
declare
  webhook_url text := 'https://machadocunha.app.n8n.cloud/webhook-test/0d65548d-5254-441e-ba4b-d5d699a99de0';
  payload jsonb;
  request_id bigint;
begin
  -- Monta o JSON que será enviado para o n8n usando os nomes corretos da tabela "orders"
  ...
  -- Log do envio (opcional, bom para debugar no supabase logs)
  raise notice 'Enviando webhook para n8n: %', payload;

  -- Faz a requisição POST assíncrona usando pg_net
...
ALTER FUNCTION "public"."notify_n8n_pedido_status"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."registrar_pagamento_comanda"("p_company_id" "uuid", "p_comanda_id" "uuid", "p_comanda_number" "text", "p_date_key" "text", "p_valor" numeric, "p_forma" "text", "p_usuario_id" "uuid", "p_usuario_nome" "text", "p_total_pago" numeric, "p_saldo_aberto" numeric, "p_pagamentos_resumo" "jsonb", "p_garcom" "uuid", "p_garcom_nome" "text") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
  v_payment_id UUID;
...
CREATE OR REPLACE FUNCTION "public"."run_scheduled_partition_maintenance"() RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
    config RECORD;
...
CREATE OR REPLACE FUNCTION "public"."should_partition_orders"() RETURNS boolean
    LANGUAGE "plpgsql"
    AS $$
DECLARE
    row_count BIGINT;
...
CREATE OR REPLACE FUNCTION "public"."update_pizza_extras_updated_at"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
    NEW.updated_at = NOW();
...
CREATE OR REPLACE FUNCTION "public"."user_in_company"("target_company_id" "uuid") RETURNS boolean
    LANGUAGE "sql" STABLE PARALLEL SAFE
    AS $$
  SELECT EXISTS (
    SELECT 1 
...
CREATE TABLE IF NOT EXISTS "public"."agendamentos" (
    ...
    "data_hora_reserva" timestamp with time zone NOT NULL,
...
CREATE TABLE IF NOT EXISTS "public"."delivery_counters" (
    "company_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."delivery_counters" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."partition_maintenance_config" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
...
ALTER TABLE ONLY "public"."delivery_counters"
    ADD CONSTRAINT "delivery_counters_pkey" PRIMARY KEY ("company_id", "date_key");
...
CREATE INDEX "clientes_telefone_company_idx" ON "public"."clientes" USING "btree" ("company_id", "telefone");
...
CREATE UNIQUE INDEX "idx_unique_open_comanda" ON "public"."comandas" USING "btree" ("company_id", "date_key", "comanda_number") WHERE ("status" = 'aberta'::"text");



CREATE OR REPLACE TRIGGER "agendamentos_notify_trigger" AFTER INSERT OR UPDATE OF "status" ON "public"."agendamentos" FOR EACH ROW EXECUTE FUNCTION "public"."notify_agendamentos_n8n"();
...
CREATE OR REPLACE TRIGGER "on_company_created_seed_config" AFTER INSERT ON "public"."companies" FOR EACH ROW EXECUTE FUNCTION "public"."handle_new_company_config"();



CREATE OR REPLACE TRIGGER "on_pedido_status_change" AFTER UPDATE OF "status" ON "public"."orders" FOR EACH ROW WHEN (("old"."status" IS DISTINCT FROM "new"."status")) EXECUTE FUNCTION "public"."notify_n8n_pedido_status"();



CREATE OR REPLACE TRIGGER "trigger_update_pizza_extras_updated_at" BEFORE UPDATE ON "public"."pizza_extras" FOR EACH ROW EXECUTE FUNCTION "public"."update_pizza_extras_updated_at"();
...
ALTER TABLE ONLY "public"."agendamentos"
    ADD CONSTRAINT "agendamentos_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id");
...
ALTER TABLE ONLY "public"."clientes"
    ADD CONSTRAINT "clientes_company_id_fkey" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE CASCADE;
...
CREATE POLICY "Allow all authenticated to insert" ON "public"."delivery_counters" FOR INSERT TO "authenticated" WITH CHECK (("auth"."uid"() IS NOT NULL));



CREATE POLICY "Allow all authenticated to select" ON "public"."delivery_counters" FOR SELECT TO "authenticated" USING (true);



CREATE POLICY "Allow all authenticated to update" ON "public"."delivery_counters" FOR UPDATE TO "authenticated" USING (("auth"."uid"() IS NOT NULL));
...
CREATE POLICY "Enable all operations for users based on company_id" ON "public"."clientes" USING (("company_id" IN ( SELECT "profiles"."company_id"
   FROM "public"."profiles"
...
CREATE POLICY "Users can delete agendamentos from their company" ON "public"."agendamentos" FOR DELETE USING (("company_id" = ( SELECT "profiles"."company_id"
   FROM "public"."profiles"
  WHERE ("profiles"."id" = "auth"."uid"()))));
...
CREATE POLICY "Users can insert agendamentos for their company" ON "public"."agendamentos" FOR INSERT WITH CHECK (("company_id" = ( SELECT "profiles"."company_id"
   FROM "public"."profiles"
  WHERE ("profiles"."id" = "auth"."uid"()))));
...
CREATE POLICY "Users can update agendamentos from their company" ON "public"."agendamentos" FOR UPDATE USING (("company_id" = ( SELECT "profiles"."company_id"
   FROM "public"."profiles"
  WHERE ("profiles"."id" = "auth"."uid"()))));
...
CREATE POLICY "Users can view agendamentos from their company" ON "public"."agendamentos" FOR SELECT USING (("company_id" = ( SELECT "profiles"."company_id"
   FROM "public"."profiles"
  WHERE ("profiles"."id" = "auth"."uid"()))));
...
ALTER TABLE "public"."delivery_counters" ENABLE ROW LEVEL SECURITY;
...
GRANT ALL ON FUNCTION "public"."adicionar_consumo_atomico"("p_company_id" "text", "p_date_key" "text", "p_comanda_number" "text", "p_valor" numeric) TO "anon";
GRANT ALL ON FUNCTION "public"."adicionar_consumo_atomico"("p_company_id" "text", "p_date_key" "text", "p_comanda_number" "text", "p_valor" numeric) TO "authenticated";
GRANT ALL ON FUNCTION "public"."adicionar_consumo_atomico"("p_company_id" "text", "p_date_key" "text", "p_comanda_number" "text", "p_valor" numeric) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_next_delivery_comanda_number"("p_company_id" "uuid", "p_date_key" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."get_next_delivery_comanda_number"("p_company_id" "uuid", "p_date_key" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_next_delivery_comanda_number"("p_company_id" "uuid", "p_date_key" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."notify_agendamentos_n8n"() TO "anon";
GRANT ALL ON FUNCTION "public"."notify_agendamentos_n8n"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."notify_agendamentos_n8n"() TO "service_role";



GRANT ALL ON FUNCTION "public"."notify_n8n_pedido_status"() TO "anon";
GRANT ALL ON FUNCTION "public"."notify_n8n_pedido_status"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."notify_n8n_pedido_status"() TO "service_role";
...
GRANT ALL ON TABLE "public"."delivery_counters" TO "anon";
GRANT ALL ON TABLE "public"."delivery_counters" TO "authenticated";
GRANT ALL ON TABLE "public"."delivery_counters" TO "service_role";
