...
test.describe('Fluxo Principal - Balcão (Novo Pedido Direto) - Garcom 02', () => {
  test.setTimeout(120000);

  test.beforeEach(async ({ page }) => {
    console.log('Navegando para o App / Login - Garcom 02');
    await page.goto('/');
    ...
    try {
      ...
      console.log('Preenchendo credenciais de Garcom 02...');
  ...
  test('Deve conseguir criar um pedido de Balcão puro sem vínculo externo - Garcom 02', async ({ page }) => {
    ...
    await clienteInput.fill(`Cliente Balcão G02 ${uniqueId}`);
    ...
    console.log('- Pedido Balcão criado por Garcom 02!');
  });
});
