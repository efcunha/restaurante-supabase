...
test.describe('Fluxo de Pedido Delivery - Garcom 02', () => {
  ...
  test.beforeEach(async ({ page }) => {
    ...
    if (await loginEmail.isVisible()) {
      await loginEmail.fill(process.env.PLAYWRIGHT_TEST_EMAIL_GARCOM02!);
  ...
  test('Deve realizar um pedido completo de delivery - Garcom 02', async ({ page }) => {
    ...
    const clientName = `Delivery G02 ${uniqueId}`;
    ...
    console.log('✓ Pedido delivery confirmado com sucesso por Garcom 02!');
