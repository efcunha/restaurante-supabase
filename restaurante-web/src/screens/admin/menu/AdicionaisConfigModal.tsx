...
const styles = StyleSheet.create({
  ...
  closeBtn: { padding: 6 },
  closeBtnText: { fontSize: 18, color: colors.textSecondary || '#888' },
  ...
  itemRowInactive: { opacity: 0.5 },
  itemInfo: { flex: 1 },
  itemName: { fontSize: 14, fontWeight: '600', color: colors.text },
  itemDesc: { fontSize: 12, color: colors.textSecondary || '#888', marginTop: 2 },
  itemPrice: { fontSize: 12, color: colors.primary, marginTop: 2 },
  itemActions: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  iconBtn: { padding: 6 },
  iconBtnText: { fontSize: 16 },
  formSection: { marginTop: 20, backgroundColor: '#f4f6fb', borderRadius: 12, padding: 14 },
  formTitle: { fontSize: 15, fontWeight: '700', color: colors.text, marginBottom: 14 },
  label: { fontSize: 12, color: colors.textSecondary || '#888', marginBottom: 4, marginTop: 10, fontWeight: '600', textTransform: 'uppercase' },
  input: { backgroundColor: colors.white || '#fff', borderWidth: 1, borderColor: '#ddd', borderRadius: 8, paddingHorizontal: 12, paddingVertical: 10, fontSize: 14, color: colors.text },
  segmentRow: { flexDirection: 'row', gap: 8, flexWrap: 'wrap' },
  segment: { paddingHorizontal: 12, paddingVertical: 7, borderRadius: 8, borderWidth: 1, borderColor: '#ddd', backgroundColor: colors.white || '#fff' },
  segmentActive: { backgroundColor: colors.primary, borderColor: colors.primary },
  segmentText: { fontSize: 13, color: colors.text },
  segmentTextActive: { color: colors.white || '#fff', fontWeight: '700' },
  activeRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 10 },
  formButtons: { flexDirection: 'row', gap: 10, marginTop: 16 },
  cancelBtn: { flex: 1, paddingVertical: 12, borderRadius: 8, borderWidth: 1, borderColor: colors.danger || '#e74c3c', alignItems: 'center' },
