...
export default function MontagemScreen() {
  ...
  const handleToggleItem = async (orderId: string, itemIds: string | string[], _currentStatus: string) => {
    ...
    try {
      ...
      // Ajusta em background a lista inteira (allOrders), filtrando todos os pedidos afetados 
      ...
      // 4. Chamar contexto persistente DB pedindo 1-a-1 pra cada Pedido Real mapeado
