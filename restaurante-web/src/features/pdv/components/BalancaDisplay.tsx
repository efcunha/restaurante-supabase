...
export function BalancaDisplay({
  ...
  const isSimulatorSource = lastResult?.source === 'simulator';
  const sourceLabel = isSimulatorSource ? 'Simulador local' : 'Bridge fisica';
  ...
  return (
    <View style={styles.card}>
      <View style={styles.headerRow}>
        ...
        {lastResult?.source && (
          <View style={[styles.sourceBadge, isSimulatorSource ? styles.sourceBadgeSimulator : styles.sourceBadgeBridge]}>
            <Text style={[styles.sourceBadgeText, isSimulatorSource ? styles.sourceBadgeTextSimulator : styles.sourceBadgeTextBridge]}>
              {sourceLabel}
            </Text>
          </View>
        )}
      ...
      {isReading && (
        <View style={styles.spinnerRow}>
          ...
          <Text style={styles.spinnerText}>{isSimulatorSource ? 'Consultando simulador local...' : 'Consultando bridge...'}</Text>
        </View>
      )}
...
const styles = StyleSheet.create({
  ...
  sourceBadgeTextSimulator: {
    color: colors.primary,
  },
  sourceBadgeTextBridge: {
