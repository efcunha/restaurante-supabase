...
import RegisterCompanyScreen from '../../../restaurante-app/src/screens/RegisterCompanyScreen';
import {
...
const meta: Meta<typeof RegisterCompanyScreen> = {
  title: 'Projects/Restaurante App/Screens/RegisterCompanyScreen',
...
export const Error: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await clickButtonByText(canvasElement, 'CRIAR CONTA GRÁTIS');
  },
};
