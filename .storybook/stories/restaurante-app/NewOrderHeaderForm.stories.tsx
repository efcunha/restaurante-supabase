...
import { NewOrderHeaderForm } from '../../../restaurante-app/src/features/new-order/components/NewOrderHeaderForm';
import {
...
const meta: Meta<typeof NewOrderHeaderHarness> = {
  title: 'Projects/Restaurante App/Forms/NewOrderHeaderForm',
