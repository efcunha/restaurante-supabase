...
import OperationalSettingsScreen from '../../../restaurante-app/src/screens/OperationalSettingsScreen';
import {
...
const meta: Meta<typeof OperationalSettingsScreen> = {
  title: 'Projects/Restaurante App/Screens/OperationalSettingsScreen',
...
export const Filled: Story = {
  ...
  play: async ({ canvasElement }) => {
    ...
    await clickButtonByText(canvasElement, 'SALVAR CONFIGURACOES');
  },
};
