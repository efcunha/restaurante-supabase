...
export const AdicionaisService = {
  /** Busca adicionais ativos de um produto, ordenados por display_order */
  ...
  /** Busca todos os adicionais (inclusive inativos) para a tela de gerenciamento */
  ...
  /** Atualiza campos de um adicional existente */
  update: async (
    id: string,
