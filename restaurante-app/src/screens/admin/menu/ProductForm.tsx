...
const styles = StyleSheet.create({
    ...
    catBtn: { paddingVertical: 8, paddingHorizontal: 16, borderRadius: 20, backgroundColor: '#F5F1E8', borderWidth: 2, borderColor: '#E5B84A' },
    catBtnActive: { backgroundColor: '#E5B84A', borderColor: '#8B2F2F' },
    ...
    inputCenter: { backgroundColor: '#F5F1E8', borderRadius: 8, padding: 12, fontSize: 16, textAlign: 'center', borderWidth: 1, borderColor: '#E5B84A' },
