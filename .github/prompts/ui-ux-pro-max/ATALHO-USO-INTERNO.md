...
Índice de onboarding: `.github/prompts/ui-ux-pro-max/ONBOARDING-UIUX.md`
...
```bash
python .github/prompts/ui-ux-pro-max/scripts/search.py "restaurante-web DeliveryScreen checkout mobile-first para pedidos de entrega" --design-system -p "Restaurante Web Delivery" --format markdown
```

### Gerar recomendacao para app
```bash
python .github/prompts/ui-ux-pro-max/scripts/search.py "restaurante-app NovoPedidoScreen fluxo rapido de balcao com usabilidade mobile" --design-system -p "Restaurante App Novo Pedido" --format markdown
```

### Persistir Design System (Master + Override)
```bash
python .github/prompts/ui-ux-pro-max/scripts/search.py "restaurante-web DeliveryScreen checkout mobile-first" --design-system --persist --page "delivery-screen" -p "Restaurante Web Delivery"
```
